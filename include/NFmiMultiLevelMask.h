...
class NFmiMultiLevelMask 
{
 ...
 public:
	...
	void Mask (const unsigned long& theIndex, const bool& theNewState);
	bool IsMasked (const unsigned long& theIndex) const;
	void Mask (const unsigned long& theIndex, const bool& theNewState, const unsigned long& theMaskType);
	bool IsMasked (const unsigned long& theIndex, const unsigned long& theMaskType) const;
	void MaskAll (const bool& theNewState);
	void MaskAll (const bool& theNewState, const unsigned long& theMaskType);
	bool Mask (const NFmiBitMask& theMask);
	bool Mask (const NFmiBitMask& theMask, const unsigned long& theMaskType);
