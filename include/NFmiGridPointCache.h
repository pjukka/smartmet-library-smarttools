...
public:
	...
	struct Data
	{
		NFmiPoint itsOffSet; // koska lasketut hilat lasketaan (usean ruudukon karttanäytössä) eri kohdissa 0,0 - 1,1 maailmaa, pitää
							// 'originaalin' hilan offset origoon laittaa talteen, että myöhemmin voidaan laskea haluttuja offsetteja contoureille
