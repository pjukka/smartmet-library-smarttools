...
namespace NFmiDataStoringHelpers
{
	...
	// theReallyStoredSize on säästöä tarkoitettu parametri. Eli jos se on oletusarvossa -1, talletus tapahtuu normaalista
...
// oli luokan sisäisiä luokkia), joten tein for loopin, joka meni läpi.
	...
	// theUsedCurrentTime on ns. seinäkello aika. Se pitää antaa kaikille näille aikafunktioille. Siinä on normaalisti 
	// nykyhetken kellon aika minuutin tarkkuudella. Mutta jos ollaan SmartMetin CaseStudy-moodissa, laitetaankin siihen
	// kyseiseen CaseStudyyn talletettu seinäkelloaika. Tämän avulla voidaan CaseStudy-moodissa käyttää normaaleja 
