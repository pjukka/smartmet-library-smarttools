...
public:
  ...
  void BlendColor(const NFmiColor & foregroundcolor, 
  ...
  {
	if(itsColor.red == theColor.Red() &&
	   itsColor.green == theColor.Green() &&
	   itsColor.blue == theColor.Blue() &&
	   itsColor.alpha  == theColor.Alpha())
	  return true;
	return false;
  }
  ...
  friend NFmiColor operator+(const NFmiColor & aColor,
							 const NFmiColor & theOtherColor)
  {
  ...
  {
	NFmiColor color(itsColor.red   * theValue,
					itsColor.green * theValue,
					itsColor.blue  * theValue);
	return color;
  }
...
inline
void NFmiColor::SetRGBA(const FmiRGBColor & aColor)
{
...
inline
NFmiColor::NFmiColor(const NFmiColor & aColor)
  : itsColor(aColor.itsColor)
{ }

inline
NFmiColor::NFmiColor(const FmiRGBColor & aColor)
  : itsColor()
{
  SetRGBA(aColor);
}
...
inline
std::ostream & operator<<(std::ostream & os, const NFmiColor & ob)
{
  return ob.Write(os);
}

inline
std::istream & operator>>(std::istream & os, NFmiColor & ob)
{
  return ob.Read(os);
}

inline
void NFmiColor::SetRGBA(float aRedValue,
						float aGreenValue,
						float aBlueValue,
						float aAlphaValue)
{
...
inline
void NFmiColor::SetRGBA(const NFmiColor & aColor)
{
...
inline
NFmiColor::NFmiColor(float aRedValue
							,float aGreenValue
							,float aBlueValue
							,float aAlphaValue
									)
...
inline
void NFmiColor::SetRGB(float aRedValue,
					   float aGreenValue,
					   float aBlueValue)
{
...
inline
void NFmiColor::SetRGB(const FmiRGBColor & aColor)
{
  SetRGBA(aColor);
  Alpha(0.0);
}
...
inline
void NFmiColor::SetRGB(const NFmiColor & aColor)
{
  SetRGBA(aColor);
  Alpha(0.0);
}
...
inline
void NFmiColor::BlendColor(const NFmiColor & foregroundcolor, 
						   float value,
						   float minvalue,
						   float maxvalue)
{
...
inline
void NFmiColor::Mix(const NFmiColor & anOtherColor, float mixingRatio)
 {
   SetRGB ((1.F - mixingRatio) * static_cast<float>(itsColor.red) + mixingRatio * anOtherColor.Red(),
