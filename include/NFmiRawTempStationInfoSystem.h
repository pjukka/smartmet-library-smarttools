...
public:
	...
	NFmiWmoStation(void)
	:itsWmoId(0) // jostain syystä "Buckland, Buckland Airport" asemalla on 0 id, joten 0:aa ei voi pitää puuttuvan aseman arvona
...
private:
  ...
  std::string itsInitLogMessage; // onnistuneen tai epäonnistuneen initialisoinnin viesti, missä voi olla varoituksia lokiin.
};
