...
private:
	boost::shared_ptr<NFmiDrawParam> CreateDrawParam(boost::shared_ptr<NFmiDrawParam> &theDrawParam, bool fDoCrossSection);
	std::string CreateFileName(boost::shared_ptr<NFmiDrawParam> &drawParam, bool fCrossSectionCase = false);
