...
// Jos maskin itsInfo on station-dataa, sen laskut tehdään toisella tavalla kuin 'normaalin' hila-datan kanssa
// 1. Se pitää initilisoida kerran joka erillistä aikaa kohden eli lasketaan matriisiin valmiiksi kaikki arvot kerralla
// 2. Kun maskin arvoja pyydetään Value-metodissa, ne saadaan valmiiksi lasketusta taulukosta (aika initialisointi voi tapahtua myös siellä)
