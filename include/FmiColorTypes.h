...
//	typedef double FmiColorValue;
	typedef float FmiColorValue; // 10.10.2001/Marko Aikamoinen tarve ollut yhden v‰rin kertomiseen kun ollut 4 x double = 32 tavua = 256 bitti‰ (kun truecolor saadaan aikaan 32 bitill‰)
