...
namespace DecodeTEMP
{
	...
	NFmiQueryData* CreateNewQData(std::vector<NFmiTEMPCode> &theTempCodeVec, const NFmiProducer &theWantedProducer);
}
...
private:
	...
	NFmiAviationStationInfoSystem *itsTempStations; // Ei omista.  Jos tässä on luotausinfo, sitä voidaan pitää luotaus asemien "tietokantana"
