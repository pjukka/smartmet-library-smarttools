...
public:
	...
	boost::shared_ptr<NFmiOwnerInfo> OriginalData(void); // Tätä saa käyttää vain NFmiInfoOrganizer-luokka sisäisesti, koska tätä ei ole tarkoitus palauttaa, 
														// kun tarvitaan moni-säie turvallinen info-iteraattori kopio, käytetään mieluummin GetIter-metodia.
