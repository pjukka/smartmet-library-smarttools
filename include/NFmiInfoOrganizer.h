...
public:
    ...
    {   // Tämän rakenteen avulla voidaan halutessa varmistaa ainakin FindSoundingInfo -metodissa, että palautettavassa datassa on tiettyjä parametreja, esim.:
	...
	// HUOM! Että multi-threaddaus onnistuisi, pitää kaikki info-olioiden palautus funktioiden palauttaa kopio
	// iteraattori-infosta. Pitäisikö jokaiselle datalle luoda on-demandina kopio-info-olio lista, josta palautus olisi nopea?
...
private:
	...
	boost::shared_ptr<NFmiFastQueryInfo> itsMacroParamData; // makro-parametrien laskuja varten pitää pitää yllä yhden hilan kokoista dataa (yksi aika,param ja level, editoitavan datan hplaceDesc)
	NFmiDataMatrix<float> itsMacroParamMissingValueMatrix; // tähän talletetaan editoitavan datan hilan suuruinen kFloatMissing:eilla alustettu matriisi että sillä voi alustaa makroParam dataa ennen laskuja
	boost::shared_ptr<NFmiFastQueryInfo> itsCrossSectionMacroParamData; // poikkileikkaus makro-parametrien laskuja varten pitää pitää yllä yhden hilan kokoista dataa (yksi aika,param ja level, editoitavan datan hplaceDesc)
	NFmiDataMatrix<float> itsCrossSectionMacroParamMissingValueMatrix; // tähän talletetaan editoitavan datan hilan suuruinen kFloatMissing:eilla alustettu matriisi että sillä voi alustaa makroParam dataa ennen laskuja
