...
void NFmiDataStoringHelpers::WriteTimeWithOffsets(const NFmiMetTime &theUsedCurrentTime, const NFmiMetTime &theTime, std::ostream& os)
{
...
void NFmiDataStoringHelpers::ReadTimeWithOffsets(const NFmiMetTime &theUsedCurrentTime, NFmiMetTime &theTime, std::istream& is)
{
	short utcHour = 0;
	short utcMinute = 0;
	long dayShift = 0;
...
void NFmiDataStoringHelpers::ReadTimeBagWithOffSets(const NFmiMetTime &theUsedCurrentTime, NFmiTimeBag &theTimeBag, std::istream& is)
{
...
std::string NFmiDataStoringHelpers::GetTimeBagOffSetStr(const NFmiMetTime &theUsedCurrentTime, const NFmiTimeBag &theTimeBag)
{
...
NFmiTimeBag NFmiDataStoringHelpers::GetTimeBagOffSetFromStr(const NFmiMetTime &theUsedCurrentTime, const std::string &theTimeBagStr)
{
