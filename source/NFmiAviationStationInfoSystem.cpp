...
// theMinutesWithOrientationStr on arvo asteiden minuutteina ja jossa on  pohjoisella pallonpuoliskolla N ja eteläisellä pallonpuoliskolla S kirjain perässä
...
//
// loput rivit tiedostossa on asema data rivejä, joissa erotin on tabulaattori ja sarake järjestys on kuten 1. kommentti rivillä on ilmoitettu
...
//
// Kiinnostavat kohdat ovat (huom. tässä kuvauksessa sarakkeet alkaa 1.:sta, koodissa indeksit alkavat 0:sta): 
// 6. sarake (wmo-id)
// 8. sarake (asema nimi)
