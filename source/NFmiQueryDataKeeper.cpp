...
{
	WriteLock lock(itsMutex); // tämä funktio pitää suorittaa aina max yhdestä säikeestä (ainakin kun tehdään moni-säie laskuja smarttool-kielellä, missä on mukana asemadataa!!)
