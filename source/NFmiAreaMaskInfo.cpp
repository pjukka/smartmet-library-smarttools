...
,itsMaskCondition()
,itsOperationType(NFmiAreaMask::CalculationOperationType::NoType)
,itsCalculationOperator(NFmiAreaMask::CalculationOperator::NotOperation)
,itsBinaryOperator(NFmiAreaMask::BinaryOperator::kNoValue)
