...
//		itsTokenFunctions.insert(FunctionMap::value_type(string("wavg"), NFmiAreaMask::WAvg));
        ...
        itsTokenVertFunctions.insert(VertFunctionMap::value_type(string("occurrence"), VertFunctionMapValue(NFmiAreaMask::ProbOver, NFmiAreaMask::Occurrence, 5, string("occurrence(par, radius_km, time_offset1, time_offset2, end-of-condition)"))));
        ...
        // time_*-funktiot laskevat halutun operaation läpi halutun aikahaarukan. Laskut käydään läpi datan omassa aikaresoluutiossa, eli tässä ei ole aikainterpolaatioita kuten esim. maxt vastaavissa funktioissa.
        ...
        // Tässä on time-range vertikaaliset-funktiot, jotka operoivat datan omassa aika ja level resoluutiossa. 
        ...
        // timevertlev-funktiot eli näitä operoidaan aina mallipintadatan hybrid-level arvoilla esim. hirlamissa arvot ovat 60 - 1
