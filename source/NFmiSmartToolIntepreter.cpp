...
//	InitSectionInfos();
	...
	while(fGoOn)
	{
		...
		{
			if(index > 200)
				throw runtime_error("Annetusta skriptistä tuli yli 200 lasku blokkia, lopetetaan...");
...
bool NFmiSmartToolIntepreter::CheckoutPossibleNextCalculationBlock(NFmiSmartToolCalculationBlockInfo* theBlock, bool fFirstLevelCheckout)
{
	...
	if(fFirstLevelCheckout || fWasBlockMarksFound) // vain 1. tason kyselyssä jatketaan tai jos blokki merkit löytyivät {}
