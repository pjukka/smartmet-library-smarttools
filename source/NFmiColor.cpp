...
void NFmiColor::Overlay(const NFmiColor & theForegroundColor)
{
  ...
  SetRGBA(foregroundTransparency * Red() + (1.0f - foregroundTransparency) * theForegroundColor.Red(),
		  foregroundTransparency * Green() + (1.0f - foregroundTransparency) * theForegroundColor.Green(),
		  foregroundTransparency * Blue()  + (1.0f - foregroundTransparency) * theForegroundColor.Blue());
}
