...
//--------------------------------------------------------
// Tutkii lˆytyykˆ listasta itsList infoa, jossa on theParam.
...
// T‰m‰ pit‰isi korvata jotenkin muun nimisell‰ metodilla, koska nyky‰‰n ei ole drawparamissa en‰‰ infoa kuitenkaan
/*
									 ...
									 ,int theUndoLevel)
{
	...
	if(theData)
	{
		...
		NFmiSmartInfo* aSmartInfo = new NFmiSmartInfo(aQueryInfo, theData, theDataFileName, theDataType);// ...otetaan k‰yttˆˆn myˆhemmin
		if(aSmartInfo)
			aSmartInfo->First();
