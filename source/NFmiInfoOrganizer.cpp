									   ...
									   , NFmiInfoData::Type theType)
{
  if(theParam == FmiParameterName(NFmiInfoData::kFmiSpSynoPlot) ||
	 theParam == FmiParameterName(NFmiInfoData::kFmiSpMinMaxPlot)) // synop plot paramille pitää tehdä kikka (ja min/max plot 9996)
...
>>>>>>> c81c8e65c7fc23e6cf09b5927868d1301ed8d950
