...
const NFmiDataIdent& GeneralData::Param(void) const
{
  return itsParameter;
}
void GeneralData::Param(const NFmiDataIdent& theParameter)
{
  itsParameter = theParameter;
}
const NFmiLevel& GeneralData::Level(void) const
{
  return itsLevel;
}
...
void GeneralData::Level(const NFmiLevel& theLevel)
{
  itsLevel = theLevel;
}
const std::string& GeneralData::InitFileName(void) const
{
  return itsInitFileName;
}
void GeneralData::InitFileName(std::string theFileName)
{
...
const float& GeneralData::InitFileVersionNumber(void) const
{
  return itsInitFileVersionNumber;
}
...
void GeneralData::EditParam(bool newValue)
{
  fEditedParam = newValue;
}
bool GeneralData::IsParamEdited(void) const
{
  return fEditedParam;
}
void GeneralData::Unit(const std::string& theUnit)
{
  itsUnit = theUnit;
}
const std::string& GeneralData::Unit(void) const
{
  return itsUnit;
}
bool GeneralData::IsActive(void) const
{
  return fActive;
}
void GeneralData::Activate(const bool& newState)
{
  fActive = newState;
}
NFmiInfoData::Type GeneralData::DataType(void) const
{
  return itsDataType;
}
void GeneralData::DataType(const NFmiInfoData::Type& newValue)
{
  itsDataType = newValue;
}
bool GeneralData::ViewMacroDrawParam(void) const
{
  return fViewMacroDrawParam;
}
void GeneralData::ViewMacroDrawParam(const bool& newState)
{
  fViewMacroDrawParam = newState;
}
bool GeneralData::BorrowedParam(void) const
{
  return fBorrowedParam;
}
void GeneralData::BorrowedParam(const bool& newValue)
{
  fBorrowedParam = newValue;
}
const NFmiMetTime& GeneralData::ModelOriginTime(void) const
{
  return itsModelOriginTime;
}
void GeneralData::ModelOriginTime(const NFmiMetTime& newValue)
{
  itsModelOriginTime = newValue;
}
int GeneralData::ModelRunIndex(void) const
{
  return itsModelRunIndex;
}
void GeneralData::ModelRunIndex(const int& newValue)
{
  itsModelRunIndex = newValue;
}
...
int GeneralData::TimeSerialModelRunCount(void) const
{
  return itsTimeSerialModelRunCount;
}
...
int GeneralData::ModelRunDifferenceIndex(void) const
{
  return itsModelRunDifferenceIndex;
}
...
unsigned long GeneralData::DataComparisonProdId(void) const
{
  return itsDataComparisonProdId;
}
...
NFmiInfoData::Type GeneralData::DataComparisonType(void) const
{
  return itsDataComparisonType;
}
