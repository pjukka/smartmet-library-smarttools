...
NFmiMetEditorTypes::View GeneralVisualization::ViewType(void) const { return itsViewType; }
...
bool GeneralVisualization::UseIsoLineFeathering(void) const { return fUseIsoLineFeathering; }
void GeneralVisualization::UseIsoLineFeathering(bool newValue) { fUseIsoLineFeathering = newValue; }
...
bool GeneralVisualization::DrawOnlyOverMask(void) const { return fDrawOnlyOverMask; }
void GeneralVisualization::DrawOnlyOverMask(bool newValue) { fDrawOnlyOverMask = newValue; }
...
bool GeneralVisualization::UseCustomIsoLineing(void) const { return fUseCustomIsoLineing; }
void GeneralVisualization::UseCustomIsoLineing(bool newValue) { fUseCustomIsoLineing = newValue; }

int GeneralVisualization::IsoLineLabelDigitCount(void) const { return itsIsoLineLabelDigitCount; }
...
float GeneralVisualization::Alpha(void) const { return itsAlpha; }
void GeneralVisualization::Alpha(float newValue)
{
  itsAlpha = newValue;
  if (itsAlpha < GeneralVisualization::itsMinAlpha) itsAlpha = GeneralVisualization::itsMinAlpha;
  if (itsAlpha > 100.f) itsAlpha = 100.f;
}

void GeneralVisualization::HideParam(bool newValue) { fHidden = newValue; }
bool GeneralVisualization::IsParamHidden(void) const { return fHidden; }

bool GeneralVisualization::ShowDifference(void) const { return fShowDifference; }
void GeneralVisualization::ShowDifference(bool newState) { fShowDifference = newState; }
