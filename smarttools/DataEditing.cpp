...
double DataEditing::ModifyingStep(void) const
{
  return itsModifyingStep;
}
...
double DataEditing::TimeSerialModifyingLimit(void) const
{
  return itsTimeSerialModifyingLimit;
}
...
double DataEditing::AbsoluteMinValue(void) const
{
  return itsAbsoluteMinValue;
}
...
double DataEditing::AbsoluteMaxValue(void) const
{
  return itsAbsoluteMaxValue;
}
...
double DataEditing::TimeSeriesScaleMin(void) const
{
  return itsTimeSeriesScaleMin;
}
void DataEditing::TimeSeriesScaleMin(const double& theValue)
{
  itsTimeSeriesScaleMin = theValue;
}

double DataEditing::TimeSeriesScaleMax(void) const
{
  return itsTimeSeriesScaleMax;
}
void DataEditing::TimeSeriesScaleMax(const double& theValue)
{
