...
const NFmiColor& SimpleColorContour::ContourColor(void) const
{
  return itsContourColor;
}
void SimpleColorContour::ContourColor(const NFmiColor& newColor)
{
  itsContourColor = newColor;
}

float SimpleColorContour::SimpleContourWidth(void) const
{
  return itsSimpleContourWidth;
}
...
const NFmiColor& SimpleColorContour::IsolineColor() const
{
  return SimpleIsoline::IsolineColor();
}

float SimpleColorContour::SimpleIsoLineWidth() const
{
  return SimpleIsoline::SimpleIsoLineWidth();
}
...
int SimpleColorContour::SimpleContourLineStyle(void) const
{
  return itsSimpleContourLineStyle;
}
...
double SimpleColorContour::ContourGab(void) const
{
  return itsContourGab;
}
