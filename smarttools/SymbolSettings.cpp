...
void SymbolSettings::FrameColor(const NFmiColor& theFrameColor) { itsFrameColor = theFrameColor; }
const NFmiColor& SymbolSettings::FrameColor(void) const { return itsFrameColor; }

void SymbolSettings::FillColor(const NFmiColor& theFillColor) { itsFillColor = theFillColor; }
const NFmiColor& SymbolSettings::FillColor(void) const { return itsFillColor; }

void SymbolSettings::RelativeSize(const NFmiPoint& theRelativeSize)
{
  itsRelativeSize = theRelativeSize;
}
const NFmiPoint& SymbolSettings::RelativeSize(void) const { return itsRelativeSize; }
...
bool SymbolSettings::ShowNumbers(void) const { return fShowNumbers; }
void SymbolSettings::ShowNumbers(const bool& theValue) { fShowNumbers = theValue; }
bool SymbolSettings::ShowMasks(void) const { return fShowMasks; }
void SymbolSettings::ShowMasks(const bool& theValue) { fShowMasks = theValue; }
bool SymbolSettings::ShowColors(void) const { return fShowColors; }
void SymbolSettings::ShowColors(const bool& theValue) { fShowColors = theValue; }
bool SymbolSettings::ShowColoredNumbers(void) const { return fShowColoredNumbers; }
void SymbolSettings::ShowColoredNumbers(const bool& theValue) { fShowColoredNumbers = theValue; }
bool SymbolSettings::ZeroColorMean(void) const { return fZeroColorMean; }
void SymbolSettings::ZeroColorMean(const bool& theValue) { fZeroColorMean = theValue; }
...
bool SymbolSettings::UseSymbolsInTextMode(void) const { return fUseSymbolsInTextMode; }
void SymbolSettings::UseSymbolsInTextMode(const bool& newValue)
{
  fUseSymbolsInTextMode = newValue;
}
int SymbolSettings::UsedSymbolListIndex(void) const { return itsUsedSymbolListIndex; }
void SymbolSettings::UsedSymbolListIndex(const int& newValue) { itsUsedSymbolListIndex = newValue; }
int SymbolSettings::SymbolIndexingMapListIndex(void) const { return itsSymbolIndexingMapListIndex; }
