...
bool HatchSettings::UseWithIsoLineHatch1(void) const { return fUseWithIsoLineHatch1; }
void HatchSettings::UseWithIsoLineHatch1(const bool& newValue) { fUseWithIsoLineHatch1 = newValue; }
...
float HatchSettings::IsoLineHatchLowValue1(void) const { return itsIsoLineHatchLowValue1; }
void HatchSettings::IsoLineHatchLowValue1(const float& newValue)
{
  itsIsoLineHatchLowValue1 = newValue;
}
float HatchSettings::IsoLineHatchHighValue1(void) const { return itsIsoLineHatchHighValue1; }
void HatchSettings::IsoLineHatchHighValue1(const float& newValue)
{
  itsIsoLineHatchHighValue1 = newValue;
}
int HatchSettings::IsoLineHatchType1(void) const { return itsIsoLineHatchType1; }
void HatchSettings::IsoLineHatchType1(const int& newValue) { itsIsoLineHatchType1 = newValue; }
const NFmiColor& HatchSettings::IsoLineHatchColor1(void) const { return itsIsoLineHatchColor1; }
...
bool HatchSettings::UseWithIsoLineHatch2(void) const { return fUseWithIsoLineHatch2; }
void HatchSettings::UseWithIsoLineHatch2(const bool& newValue) { fUseWithIsoLineHatch2 = newValue; }
...
float HatchSettings::IsoLineHatchLowValue2(void) const { return itsIsoLineHatchLowValue2; }
void HatchSettings::IsoLineHatchLowValue2(const float& newValue)
{
  itsIsoLineHatchLowValue2 = newValue;
}
float HatchSettings::IsoLineHatchHighValue2(void) const { return itsIsoLineHatchHighValue2; }
void HatchSettings::IsoLineHatchHighValue2(const float& newValue)
{
  itsIsoLineHatchHighValue2 = newValue;
}
int HatchSettings::IsoLineHatchType2(void) const { return itsIsoLineHatchType2; }
void HatchSettings::IsoLineHatchType2(const int& newValue) { itsIsoLineHatchType2 = newValue; }
const NFmiColor& HatchSettings::IsoLineHatchColor2(void) const { return itsIsoLineHatchColor2; }
